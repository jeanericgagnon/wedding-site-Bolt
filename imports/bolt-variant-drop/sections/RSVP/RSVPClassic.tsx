      ...
      <div className="max-w-2xl mx-auto px-4">
        ...
        <form className="space-y-6 bg-white p-8 rounded-xl shadow-lg">
          ...
          <div>
            ...
            <select className="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-rose-400 focus:border-transparent">
          ...
          <button
            type="submit"
            className="w-full bg-rose-500 text-white py-4 rounded-xl hover:bg-rose-600 transition-colors flex items-center justify-center gap-2 font-medium text-lg"
          >
