...
- Latest shipped batch: `pending local batch` `Clarify registry share-readiness review wording`
...
- `Latest batch list`
  - `pending local batch` `Clarify registry share-readiness review wording`
