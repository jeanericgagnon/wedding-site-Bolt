...
export const VENDOR_ACCENT_OPTIONS: Array<{ id: VendorAccentId; name: string; detail: string }> = [
  ...
  { id: 'ink', name: 'Ink', detail: 'High-contrast accent for photo, music, and simple vendor pages.' },
];
...
const SAMPLE_VENDOR_PROFILES: Record<string, VendorProfile> = {
  everlight: {
    ...
    source_payload: {
      ...
      vendor_customization: {
        ...
        pricing_note: 'Full weekend photos begin with planning and schedule help.',
        proof_points: ['Film-toned edits', 'Calm schedule help', 'Early photos'],
        category_facts: [
          ...
          { label: 'Good when', value: 'Calm direction and real moments matter', group: 'overview' },
        ],
        packages: [
          { title: 'Wedding day photos', detail: 'Documentary photo time with schedule help, early photos, and an online gallery.', price: 'Start' },
          { title: 'Weekend story', detail: 'Welcome party, rehearsal, wedding day, and next morning moments in one gallery.', price: 'Event count' },
        ],
        testimonials: [
          { quote: 'They made the day feel calm and still caught everything we cared about.', attribution: 'Couple note' },
        ],
        faqs: [
          { question: 'Do you help with photo schedule planning?', answer: 'Yes. Schedule notes and family photo pacing can be included before the wedding day.' },
  ...
  'dayof-sample-floral': {
    ...
    source_payload: {
      ...
      vendor_customization: {
        ...
        pricing_note: 'Add ceremony installs, reception flowers, and visual direction.',
        proof_points: ['Seasonal palette', 'Large-scale installs', 'Rental plan'],
        category_facts: [
          { label: 'Install plan', value: 'Ceremony pieces, bars, lounges, and reception tables', group: 'service' },
          ...
          { label: 'Breakdown', value: 'Strike and rental plan can be included', group: 'service' },
        ...
        rating: {
          enabled: true,
          overall_score: null,
          summary: 'Helpful for seasonal color, installation presence, and rental planning.',
          categories: [],
        },
        packages: [
          { title: 'Ceremony install', detail: 'Statement aisle flowers, altar moment, strike plan, and repurpose notes.', price: 'Start' },
          { title: 'Reception flowers', detail: 'Tablescape florals, candles, personal flowers, and delivery schedule.', price: 'Guest count' },
        ],
        testimonials: [
          { quote: 'The florals felt abundant, personal, and right for the season.', attribution: 'Couple note' },
        ],
        faqs: [
          ...
          { question: 'Do you handle setup and breakdown?', answer: 'Installation, strike, and rental planning can be included in the floral notes.' },
        ],
        inquiry_questions: ['Guest count', 'Color palette or inspiration', 'Install moments you care about'],
      },
    },
  },
  'dayof-sample-venue': {
    ...
    about: 'Stonehouse Estate hosts wedding weekends with a ceremony garden, indoor dinner space, and enough property notes to make the day feel organized from arrival to sendoff.',
    ...
    source_payload: {
      ...
      vendor_customization: {
        ...
        proof_points: ['Ceremony garden', 'Rain plan notes', 'Guest parking'],
        category_facts: [
          ...
          { label: 'Parking', value: 'Guest parking and load-in plan', group: 'logistics' },
          { label: 'Good when', value: 'The weekend has multiple guest moments', group: 'overview' },
        ],
        packages: [
          { title: 'Site walkthrough', detail: 'Walk the ceremony, cocktail, dinner, and rain plan spaces with the venue team.', price: 'Tour' },
          { title: 'Wedding weekend plans', detail: 'Site use, load-in windows, guest flow, and property schedule planned together.', price: 'Season' },
        ],
        testimonials: [
          { quote: 'The property made the whole weekend feel easy to understand.', attribution: 'Couple note' },
        ],
        faqs: [
          ...
          { question: 'Can teams set up before the wedding day?', answer: 'Setup windows can be planned with the venue team based on event notes.' },
        ],
  ...
  'dayof-sample-catering': {
    ...
    about: 'Sage Table builds menus around regional ingredients, guest flow, and schedule notes, from welcome cocktails to family style dinners and cake cutting.',
    ...
    source_payload: {
      ...
      vendor_customization: {
        ...
        category_facts: [
          ...
          { label: 'Tastings', value: 'Tasting plan can follow the first message', group: 'service' },
          ...
          { label: 'Good when', value: 'Seasonal menus and steady guest flow matter', group: 'overview' },
        ],
        packages: [
        ...
        testimonials: [
          { quote: 'The food felt personal without slowing down the party.', attribution: 'Couple note' },
        ],
        faqs: [
          { question: 'Can you handle dietary notes?', answer: 'Yes. Dietary notes are collected during menu planning and confirmed before final counts.' },
  ...
  'modern-events': {
    ...
    source_payload: {
      ...
      vendor_customization: {
        accent_id: 'sage',
        cta_label: 'Send note about your date',
...
function buildFallbackVendorProfileDraft(input: { vendorName: string; instagramUrl?: string; websiteUrl?: string }): VendorProfileDraft {
  ...
  return {
    ...
    about: `${vendorName} has a simple page with links, a direct way to reply, and room for stronger images as notes are added.`,
    hero_image_url: null,
    image_urls: [],
    ...
    contact_email: null,
    source_payload: {
      sourceLabel: websiteLabel ?? 'typed details',
