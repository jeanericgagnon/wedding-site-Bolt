...
describe('dashboard data boundary guards', () => {
  ...
  it('does not load message dashboard rows with select star', () => {
    ...
    expect(serviceSource).toContain('const MAX_DASHBOARD_MESSAGES = 500');
    expect(serviceSource).toContain('const MAX_MESSAGE_GUESTS = 2000');
    expect(serviceSource).toContain('const MAX_MESSAGE_AUDIENCE_EVENTS = 200');
    expect(serviceSource).toContain('const MAX_MESSAGE_EVENT_INVITATIONS = 10000');
    expect(serviceSource).toContain('.limit(MAX_DASHBOARD_MESSAGES)');
    expect(serviceSource).toContain('.limit(MAX_MESSAGE_GUESTS)');
    expect(serviceSource).toContain('.limit(MAX_MESSAGE_AUDIENCE_EVENTS)');
    expect(serviceSource).toContain('.limit(MAX_MESSAGE_EVENT_INVITATIONS)');
  ...
  it('loads guest dashboard guest and RSVP rows with explicit projections', () => {
    ...
    expect(service).toContain('const MAX_GUEST_DASHBOARD_GUESTS = 2000');
    expect(service).toContain('const MAX_GUEST_ITINERARY_EVENTS = 200');
    expect(service).toContain('const MAX_GUEST_EVENT_INVITATIONS = 10000');
    ...
    expect(service).toContain('.limit(MAX_GUEST_DASHBOARD_GUESTS)');
    expect(service).toContain('.limit(MAX_GUEST_ITINERARY_EVENTS)');
    expect(service).toContain('.limit(MAX_GUEST_EVENT_INVITATIONS)');
  ...
  it('loads itinerary events and event guest picker rows with explicit projections', () => {
    ...
    expect(service).toContain('const MAX_EVENT_GUEST_PICKER_GUESTS = 2000');
    expect(service).toContain('const MAX_EVENT_GUEST_PICKER_INVITATIONS = 10000');
    ...
    expect(service).toContain('.limit(MAX_EVENT_GUEST_PICKER_GUESTS)');
    expect(service).toContain('.limit(MAX_EVENT_GUEST_PICKER_INVITATIONS)');
  ...
  it('loads seating service rows with explicit projections', () => {
    ...
    expect(source).toContain('const MAX_SEATING_ITINERARY_EVENTS = 200');
    expect(source).toContain('const MAX_SEATING_LOOKUP_ASSIGNMENTS = 2000');
    ...
    expect(source).toContain('.limit(MAX_SEATING_ITINERARY_EVENTS)');
    expect(source).toContain('.limit(MAX_SEATING_LOOKUP_ASSIGNMENTS)');
  ...
  it('keeps coordinator mode dashboard reads and writes behind its service', () => {
    ...
    expect(service).toContain('const MAX_COORDINATOR_GUESTS = 2000');
    expect(service).toContain('const MAX_COORDINATOR_EVENTS = 200');
    expect(service).toContain('const MAX_COORDINATOR_EVENT_INVITATIONS = 10000');
    ...
    expect(service).toContain('.limit(MAX_COORDINATOR_GUESTS)');
    expect(service).toContain('.limit(MAX_COORDINATOR_EVENTS)');
    expect(service).toContain('.limit(MAX_COORDINATOR_EVENT_INVITATIONS)');
  ...
  it('keeps overview intelligence persistence behind its service', () => {
    ...
    expect(service).toContain('const MAX_OVERVIEW_GUESTS = 2000');
    ...
    expect(service).toContain('.limit(MAX_OVERVIEW_GUESTS)');
  ...
  it('keeps RSVP board reads behind its service', () => {
    ...
    expect(service).toContain('const MAX_RSVP_BOARD_GUESTS = 2000');
    expect(service).toContain('const MAX_RSVP_BOARD_EVENTS = 200');
    expect(service).toContain('const MAX_RSVP_BOARD_EVENT_INVITATIONS = 10000');
    ...
    expect(service).toContain('.limit(MAX_RSVP_BOARD_GUESTS)');
    expect(service).toContain('.limit(MAX_RSVP_BOARD_EVENTS)');
    expect(service).toContain('.limit(MAX_RSVP_BOARD_EVENT_INVITATIONS)');
    expect(service).not.toContain(".from('guests')\n    .select('*')");
    expect(service).not.toContain(".from('itinerary_events')\n    .select('*')");
  ...
  it('keeps guest photo dashboard reads and writes behind its service', () => {
    ...
    expect(service).toContain('const MAX_GUEST_PHOTO_EVENTS = 200');
    expect(service).toContain('const MAX_GUEST_PHOTO_ALBUMS = 500');
    ...
    expect(service).toContain('.limit(MAX_GUEST_PHOTO_EVENTS)');
    expect(service).toContain('.limit(MAX_GUEST_PHOTO_ALBUMS)');
    expect(service).not.toContain(".from('wedding_sites')\n    .select('*')");
