...
describe('onboarding success cleanup', () => {
  beforeEach(() => {
    window.localStorage.clear();
  });

  it('can clear full continuation state when onboarding finishes successfully', () => {
  ...
  it('can clear scoped continuation state when onboarding finishes successfully too', () => {
