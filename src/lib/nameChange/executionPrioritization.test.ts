...
function makeSnapshot(overrides: Partial<NameChangeTargetExecutionSnapshot> = {}): NameChangeTargetExecutionSnapshot {
  return {
    ...
    statusVault: {
      status: 'blocked',
      proofSummary: 'Proof needs attention.',
      proofCounts: { ready: 0, attention: 0, missing: 0, total: 0 },
      notes: [],
      executionNote: null,
      milestoneNote: null,
      proofNote: null,
      ...
      executionCounts: { todo: 0, inProgress: 0, complete: 0, total: 0 },
      milestoneCounts: { inProgress: 0, complete: 0, total: 0 },
      reminderSummary: { openCount: 0, highUrgencyCount: 0, latestReminderAt: null },
    },
    readinessSummary: {
      status: 'blocked',
