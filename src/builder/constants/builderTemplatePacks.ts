...
export const BUILDER_TEMPLATE_PACKS: Record<string, BuilderTemplateDefinition> = {
  ...
  'editorial-romance-ivory': {
    ...
    sectionVariantMap: {
      hero: 'fullbleed', story: 'centered', venue: 'card', schedule: 'agendaCards', travel: 'list', gallery: 'masonry', registry: 'minimal', rsvp: 'inline',
    },
    suggestedFonts: { heading: 'Cormorant Garamond', body: 'Lato' },
    spacingProfile: 'spacious',
    isNew: true,
  ...
  'editorial-romance-midnight': {
    ...
    sectionVariantMap: {
      hero: 'fullbleed', story: 'split', venue: 'splitMap', schedule: 'timeline', travel: 'hotelBlock', gallery: 'filmStrip', registry: 'featured', rsvp: 'card',
    },
    suggestedFonts: { heading: 'Playfair Display', body: 'Inter' },
    spacingProfile: 'spacious',
    isNew: true,
  ...
  'floral-garden-sage': {
    ...
    sectionVariantMap: {
      hero: 'fullbleed', story: 'split', venue: 'card', schedule: 'agendaCards', gallery: 'polaroid', registry: 'cards', faq: 'accordion', rsvp: 'default',
    },
    suggestedFonts: { heading: 'Gilda Display', body: 'Nunito' },
    spacingProfile: 'balanced',
    isNew: true,
  ...
  'floral-garden-rose': {
    ...
    sectionVariantMap: {
      hero: 'fullbleed', story: 'centered', venue: 'detailsFirst', schedule: 'agendaCards', travel: 'list', gallery: 'masonry', registry: 'cards', rsvp: 'inline',
    },
    suggestedFonts: { heading: 'Cormorant Garamond', body: 'Lato' },
    spacingProfile: 'spacious',
    isNew: true,
