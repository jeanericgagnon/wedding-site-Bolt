...
function GuidanceSequence({
  ...
  return (
    <div className="grid gap-2 sm:grid-cols-3">
      {steps.map((step) => (
        <div key={step.label} className="rounded-lg border border-gray-200 bg-white px-3 py-2.5">
          <div className="inline-flex rounded-full bg-gray-100 px-2 py-0.5 text-[10px] font-semibold uppercase tracking-wide text-gray-500">
            {step.label}
          </div>
          <div className="mt-2 text-xs font-semibold text-gray-800">{step.title}</div>
          <p className="mt-1 text-[11px] leading-relaxed text-gray-500">{step.detail}</p>
        </div>
      ))}
    </div>
  );
      ...
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-2xl flex flex-col overflow-hidden" style={{ maxHeight: '85vh' }}>
        ...
        <div className="px-6 pb-3">
          <div className="rounded-xl border border-gray-200 bg-gray-50 px-3 py-3 space-y-3">
            <div className="flex items-start justify-between gap-3">
              <div>
                <div className="text-[11px] font-semibold uppercase tracking-wide text-gray-500">Main focus</div>
                <div className="mt-1 text-sm font-semibold text-gray-800">{summary.focusTitle}</div>
                <p className="mt-1 text-xs leading-relaxed text-gray-500">{summary.focusDetail}</p>
              </div>
            ...
            <div className="rounded-lg border border-gray-200 bg-white px-3 py-3">
              ...
              <p className="mt-1 text-xs leading-relaxed text-gray-700">{summary.bestNextMove}</p>
              <div className="mt-3 grid gap-2 sm:grid-cols-2">
                <div className="rounded-lg bg-gray-50 px-3 py-2">
                  <div className="text-[10px] font-semibold uppercase tracking-wide text-gray-500">Decision rule</div>
                  <p className="mt-1 text-[11px] leading-relaxed text-gray-600">{summary.decisionRule}</p>
                </div>
                <div className="rounded-lg bg-amber-50 px-3 py-2">
                  <div className="text-[10px] font-semibold uppercase tracking-wide text-amber-700">Watchout</div>
                  <p className="mt-1 text-[11px] leading-relaxed text-amber-800/80">{summary.watchout}</p>
                </div>
              </div>
            </div>
            <GuidanceSequence
              steps={[
                { label: 'Current', ...summary.currentStep },
                { label: 'Next', ...summary.nextStep },
                { label: 'Then', ...summary.thenStep },
              ]}
            />
        ...
        <div className="flex-1 overflow-y-auto px-6 pb-4">
          ...
          <div className="rounded-xl border border-gray-200 bg-white px-4 py-3 mt-4">
            ...
            <p className="mt-3 text-xs leading-relaxed text-gray-600">{summary.bestNextMove}</p>
          </div>
        </div>
