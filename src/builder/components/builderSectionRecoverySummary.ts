...
export function getBuilderSectionRecoverySummary(sections: BuilderSectionLike[]): BuilderSectionRecoverySummary {
  ...
  if (base.visible === 0 && hiddenSections.length > 0) {
    ...
    return {
      ...
      watchout: 'If you keep adding sections instead of recovering the hidden ones, the page quietly splits into live work and abandoned work.',
  ...
  if (hiddenSections.length > 0) {
    ...
    return {
      ...
      watchout: 'If hidden sections never get resolved, the page becomes harder to trust because the live story and the draft story drift apart.',
