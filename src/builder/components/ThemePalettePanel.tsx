              ...
              <div className="rounded-xl border border-gray-200 bg-gray-50 px-3 py-3 space-y-2">
                <div className="flex items-start justify-between gap-3">
                  <div>
                    ...
                    <div className="mt-1 text-sm font-semibold text-gray-800">{themeSummary.focusTitle}</div>
                    <p className="mt-1 text-xs leading-relaxed text-gray-500">{themeSummary.focusDetail}</p>
                  </div>
                ...
                <div className="rounded-lg border border-gray-200 bg-white px-3 py-3">
                  ...
                  <p className="mt-1 text-xs leading-relaxed text-gray-700">{themeSummary.bestNextMove}</p>
                  <div className="mt-3 grid gap-2 sm:grid-cols-2">
                    <div className="rounded-lg bg-gray-50 px-3 py-2">
                      <div className="text-[10px] font-semibold uppercase tracking-wide text-gray-500">Decision rule</div>
                      <p className="mt-1 text-[11px] leading-relaxed text-gray-600">{themeSummary.decisionRule}</p>
                    </div>
                    <div className="rounded-lg bg-amber-50 px-3 py-2">
                      <div className="text-[10px] font-semibold uppercase tracking-wide text-amber-700">Watchout</div>
                      <p className="mt-1 text-[11px] leading-relaxed text-amber-800/80">{themeSummary.watchout}</p>
                    </div>
                  </div>
                </div>
                <GuidanceSequence
                  steps={[
                    { label: 'Current', ...themeSummary.currentStep },
                    { label: 'Next', ...themeSummary.nextStep },
                    { label: 'Then', ...themeSummary.thenStep },
                  ]}
                />
              </div>
