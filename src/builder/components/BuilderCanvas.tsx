...
export const BuilderCanvas: React.FC = () => {
  ...
  return (
    <div
      className={`flex-1 min-h-0 overflow-y-auto overscroll-contain ${isPreview ? 'bg-white' : 'bg-transparent px-2 pt-1 pb-0'} ${isPreview && previewViewport === 'mobile' ? 'px-3 py-4' : ''}`}
    ...
    >
      ...
      >
        ...
        >
          {!isPreview && (
            <div className="bg-neutral-100 border-b border-neutral-200 flex items-center gap-1.5 px-3 py-2">
