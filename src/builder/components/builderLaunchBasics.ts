  ...
  switch (issueKind) {
    case 'missing-couple-names':
      return {
        ...
        bestNextMove: 'Fill in both names exactly as you want them shown across the live site.',
    ...
    case 'rsvp-disabled':
      return {
        ...
        decisionRule: 'If the site is the guest action surface, the reply path should be live before launch.',
