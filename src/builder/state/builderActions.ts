...
export const builderActions = {
  ...
  addPage: (title?: string, initialSectionType?: BuilderSectionType): BuilderAction => ({ type: 'ADD_PAGE', payload: { title, initialSectionType } }),
  ...
  setPreviewViewport: (viewport: 'desktop' | 'tablet' | 'mobile'): BuilderAction => ({ type: 'SET_PREVIEW_VIEWPORT', payload: viewport }),
