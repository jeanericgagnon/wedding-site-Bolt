...
export const SECTION_MANIFESTS: Record<BuilderSectionType, BuilderSectionDefinitionWithMeta> = {
  ...
  travel: {
    ...
    variantMeta: [
      ...
      { id: 'thingsToDo', label: 'Things To Do', description: 'Local recommendations section for guests extending their stay' },
  ...
  faq: {
    ...
    variantMeta: [
      ...
      { id: 'iconGrid', label: 'Icon Grid', description: 'Card grid with icon-led FAQ entries for quick scanning' },
  ...
  'wedding-party': {
    ...
    settingsSchema: {
      fields: [
        ...
        { key: 'bridalTitle', label: "Partner 1 Side Label", type: 'text', placeholder: "Partner 1's side" },
        { key: 'groomTitle', label: "Partner 2 Side Label", type: 'text', placeholder: "Partner 2's side" },
      ],
    },
    bindingsSchema: { slots: [] },
