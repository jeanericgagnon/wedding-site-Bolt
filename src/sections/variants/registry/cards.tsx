  ...
  links: [
    {
      ...
      store: 'Crate & Barrel',
      url: '#',
      description: 'Kitchen, home, and entertaining essentials',
      logo: '',
    },
    {
      id: '2',
    ...
    },
    {
      ...
      store: 'Pottery Barn',
      url: '#',
      description: 'Bedding, décor, and furniture',
      logo: '',
    },
  ],
    ...
    <section className="py-24 md:py-32 bg-white" id="registry">
      <div className="max-w-4xl mx-auto px-6 md:px-12">
        <div className="text-center mb-12">
          ...
          {data.message && (
            <p className="text-stone-500 text-base font-light leading-relaxed max-w-2xl mx-auto">
              {data.message}
            </p>
          )}
        </div>
