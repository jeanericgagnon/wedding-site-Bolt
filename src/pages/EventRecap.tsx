  ...
  return (
    <div className="min-h-screen bg-[#fbf7f1] text-neutral-950">
      <main className="mx-auto w-full max-w-6xl px-4 py-6 sm:px-6 sm:py-10">
        ...
        {loading && <div className="mt-6 rounded-lg border border-neutral-200 bg-white p-6 text-neutral-600">{t('event_recap.loading')}</div>}
        {error && <div className="mt-6 rounded-lg border border-neutral-200 bg-neutral-50 p-6 text-neutral-700">{error}</div>}
        ...
        {data && data.highlights.length > 0 && (
          <section className="mt-6">
            ...
            <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
              {data.highlights.slice(0, 12).map((card) => (
          ...
          <section className="mt-6 grid gap-6 lg:grid-cols-[1.1fr_0.9fr]">
            <div className="rounded-lg border border-neutral-200 bg-white p-5">
              ...
              <div className="mt-4 space-y-3">
                {data.chapters.slice(0, 6).map((chapter) => (
