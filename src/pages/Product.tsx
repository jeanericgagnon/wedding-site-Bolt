...
const STEPS: Step[] = [
  { id: 'launch', title: 'Launch a site you’re proud to share', kicker: 'Step 1', outcome: 'Build something polished privately, then launch it for guests when you are ready.', detail: 'Start with a strong template, clear setup, and a clean path from draft editing to a guest-facing launch.' },
