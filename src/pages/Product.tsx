...
const STEPS: Step[] = [
  { id: 'launch', title: 'Launch a site you’re proud to share', kicker: 'Step 1', outcome: SITE_TRUST_COPY.privateEditing, detail: `Start with a strong template, clear setup, and ${SITE_TRUST_COPY.draftToLaunch.toLowerCase()}` },
      ...
      <section className="section-shell bg-surface border-t border-border-subtle">
        <div className="container-custom max-w-6xl">
          <SlideReveal from="left" className="mb-6">
            ...
            <p className="mt-3 max-w-3xl text-ink/75">DayOf should be judged on whether the core wedding flow is trustworthy where proof exists, with the remaining gaps called out plainly instead of blurred into the v1 line. Some surrounding slices are real product direction, but they should not get to blur the current v1 line.</p>
          </SlideReveal>
