...
export const Product: React.FC = () => {
  ...
  const pains = [
    ...
    { icon: Clock,         title: 'Clear RSVP deadlines',                desc: 'Clear cutoffs with per-timezone display, plus friendly guidance for late replies.' },
    { icon: AlertTriangle, title: 'Consistent guest responses',          desc: 'Token-based RSVP helps keep responses clean and avoids accidental duplicates.' },
    { icon: Shield,        title: 'Private by default',                  desc: 'Invite-only access and noindex controls are built in from day one.' },
    { icon: Bell,          title: 'Guest-friendly messaging consent',    desc: 'Built-in consent handling helps you message guests responsibly.' },
    { icon: Globe,         title: 'Reliable timezone handling',          desc: 'Times stay accurate across locations, including DST changes.' },
    { icon: DollarSign,    title: 'Flexible registry links',             desc: 'Use links from any store and keep your registry easy to manage.' },
    { icon: Camera,        title: 'Simple photo sharing',                desc: 'Guests upload photos from a browser link—no app or account needed.' },
