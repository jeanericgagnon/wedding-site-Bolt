        ...
        <Card variant="default" padding="lg" className="shadow-lg">
          {hasInviteContext && (
            <div className="mb-5 rounded-2xl border border-border-subtle bg-surface-subtle/30 p-4 text-left">
              ...
              <div className="mt-4 grid gap-3 rounded-2xl border border-border-subtle bg-white/80 p-4 sm:grid-cols-2 lg:grid-cols-4">
                <div>
                ...
                <div>
                  ...
                  <p className="mt-1 text-sm font-semibold text-text-primary">{collaboratorRoleGuide.watchout}</p>
                </div>
              </div>
