...
export const Home: React.FC = () => {
  ...
  const featurePanels = [
    ...
    },
    {
      ...
      bullets: ['Email included (fair-use)', 'Guest segmentation', 'Schedule sends', 'Delivery status updates', 'Draft + scheduled send flow', 'Review-before-send message templates'],
    },
    {
      id: 'planner',
