...
const V1_TRUST_LINE = [
  {
    ...
    badge: 'Must ship',
    tone: 'must',
    body: 'DayOf should be judged on whether couples can build a polished wedding site draft, collect RSVPs, manage guests, send core updates, run seating, and coordinate the event week from one grounded product story, with any remaining proof gaps called out plainly instead of marketed away.',
  },
  {
