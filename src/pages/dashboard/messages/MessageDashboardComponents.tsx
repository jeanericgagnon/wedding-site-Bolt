...
import { AtSign, Calendar, CheckCircle, AlertCircle, ChevronDown, ChevronUp, Clock, Copy, Eye, Loader2, Mail, Link2, RefreshCw, Send, Users } from 'lucide-react';
...
interface ComposerLanguagePreview {
  body: string;
  label: string;
  language: string;
  note: string;
