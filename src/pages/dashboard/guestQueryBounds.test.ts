...
describe('guest query bounds', () => {
  it('caps guest dashboard and itinerary helper reads', () => {
    ...
    expect(service).toContain('export const MAX_GUEST_ITINERARY_FILTER_EVENTS = 200;');
    expect(service).toContain('export const MAX_GUEST_ITINERARY_FILTER_INVITATIONS = 10000;');
    expect(service).toContain('export const MAX_GUEST_DRAWER_EVENTS = 200;');
    expect(service).toContain('export const MAX_GUEST_DRAWER_INVITATIONS = 10000;');
    expect(service).toContain('export const MAX_GUEST_DRAWER_AUDIT_ROWS = 12;');
    ...
    expect(service).toContain(".order('changed_at', { ascending: false })\n    .limit(MAX_GUEST_AUDIT_ROWS);");
  });
});
