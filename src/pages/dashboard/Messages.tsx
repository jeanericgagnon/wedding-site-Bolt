    ...
    <DashboardLayout currentPage="messages">
      <div className="max-w-7xl mx-auto space-y-8">
        ...
        <Card variant="bordered" padding="lg" className="border-border-subtle shadow-sm overflow-hidden">
          ...
          <div className="rounded-lg border border-border/35 bg-surface-subtle/40 px-3 py-2 text-[11px] text-text-secondary mb-4">
            Delivery health is based on message and delivery logs currently available in this workspace. If provider rows are missing, treat these as partial visibility rather than full-provider truth.
          </div>
          ...
          <div className="rounded-xl border border-border/35 bg-white p-3 mb-4">
            <div className="flex items-start justify-between gap-3 mb-2">
              <div>
                <p className="text-sm font-medium text-text-primary">Provider delivery evidence</p>
                <p className="text-[11px] text-text-tertiary mt-0.5">Only counts attempts that produced delivery-log rows.</p>
              </div>
              <span className="rounded-full border border-border bg-surface-subtle px-2 py-0.5 text-[10px] text-text-secondary">{providerTelemetry.attempted > 0 ? 'Measured from logs' : 'No provider log rows yet'}</span>
            </div>
            ...
            {providerTelemetry.errorTop.length > 0 ? (
              ...
              <p className="text-[11px] text-text-tertiary">No provider failure reasons are available yet.</p>
            )}
          </div>
