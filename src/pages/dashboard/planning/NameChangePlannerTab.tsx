...
import { AlertTriangle, CheckCircle2, FileCheck2, FileStack, MapPinned, Sparkles } from 'lucide-react';
...
import { NameChangeAccountUpdateTemplatesCard } from './NameChangeAccountUpdateTemplatesCard';
import { ExecutionSnapshotCard, NameChangePlannerIntroCards, ReminderPostureCard } from './NameChangePlannerCards';

function scrollToPlannerTarget(targetId: string): void {
...
const scrollToPlannerHref = (href: string): void => scrollToPlannerTarget(href.split('#')[1] || 'name-change-roadmap');
  ...
  return (
    <div id="name-change-roadmap" className="space-y-6 scroll-mt-24">
      <NameChangePlannerIntroCards
        ...
        nextOptionalMilestone={nextOptionalMilestone}
        onSave={onSave}
        plan={plan}
        resumeCard={resumeCard}
        saving={saving}
        scrollToHref={scrollToPlannerHref}
      ...
      <div className="grid gap-4 xl:grid-cols-[1fr,1fr]">
        ...
        <NameChangeAccountUpdateTemplatesCard
          copiedTemplateId={copiedTemplateId}
          templates={accountUpdateTemplates}
          onCopyTemplate={(template) => void copyAccountUpdateTemplate(template)}
        />
      </div>
