...
export const VAULT_LOAD_RETRY_ERROR = 'Could not load vault data right now. Please try again.';
export const VAULT_STARTER_LOAD_RETRY_ERROR = 'Could not load starter vaults right now. Please try again.';
export const VAULT_ADD_RETRY_ERROR = 'Could not add that vault right now. Please try again.';
export const VAULT_UPDATE_RETRY_ERROR = 'Could not update this vault right now. Please try again.';
export const VAULT_ENTRY_DELETE_RETRY_ERROR = 'Could not remove that entry right now. Please try again.';
export const VAULT_ENTRY_DELETE_BATCH_RETRY_ERROR = 'Could not remove entries from this vault right now. Please try again.';
export const VAULT_DELETE_RETRY_ERROR = 'Could not remove this vault right now. Please try again.';
export const VAULT_DRIVE_HEALTH_RETRY_ERROR = 'Drive health check failed.';
export const VAULT_DRIVE_CONNECT_RETRY_ERROR = 'Could not start Google Drive connection right now.';
