  ...
  return (
    <div className="h-screen bg-[#f6f6f6] text-text-primary overflow-hidden">
      <div className="w-full px-0 py-0 h-full flex flex-col gap-0 [--topbar-h:46px] [--rail-head-h:50px] [--page-row-h:52px]">
        ...
        <div className={`grid grid-cols-1 ${focusPreview ? 'lg:grid-cols-1' : showStructure && showProperties ? 'lg:grid-cols-[160px_minmax(0,1fr)_440px]' : showProperties ? 'lg:grid-cols-[minmax(0,1fr)_440px]' : showStructure ? 'lg:grid-cols-[160px_minmax(0,1fr)]' : 'lg:grid-cols-1'} gap-0 flex-1 min-h-0`}>
