...
begin
  ...
  if p_guest_id is null then
    ...
    values (
      ...
      nullif(trim(lower(p_payload->>'preferred_language')), ''),
  ...
  set
    ...
    preferred_language = case when p_payload ? 'preferred_language' then nullif(trim(lower(p_payload->>'preferred_language')), '') else v_existing.preferred_language end,
