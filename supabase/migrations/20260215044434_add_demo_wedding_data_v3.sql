/*
  # Add Demo Wedding Data

  ## Overview
  Populates the database with comprehensive demo data for the demo user account.
  This creates a fully-featured wedding site with realistic sample data.
  ...
  - Custom site URL: alex-jordan-2026

  ### 2. Guest List (10 guests)
  - Mix of confirmed, pending, and declined RSVPs
  - Various meal preferences
  - Some with plus ones
  - Different household groupings

  ### 3. Photos (6 sample photos)
  - Engagement photos
  - Venue photos
  - Various categories

  ### 4. Registry Items (8 items)
  - Mix of priority levels
  - Some partially purchased
  - Various price ranges

  ### 5. Site Content (4 sections)
  - Our Story
  - Schedule
  - Travel & Accommodations
  - FAQ

  ### 6. Messages (3 sample messages)
  - Save the date announcement
  - RSVP reminder
  - Thank you message

  ## Notes
  - All data is for demo user ID: 00000000-0000-0000-0000-000000000001
  - Uses IF NOT EXISTS to prevent duplicate data
  - Safe to run multiple times
*/

-- First, check if demo wedding site already exists
DO $$
DECLARE
  demo_site_id uuid;
  household_1 uuid;
...
BEGIN
  ...
  SELECT id INTO demo_site_id
  FROM wedding_sites
  WHERE user_id = '00000000-0000-0000-0000-000000000001'
  LIMIT 1;

  -- If no demo site exists, create everything
