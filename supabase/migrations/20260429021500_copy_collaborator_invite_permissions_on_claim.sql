/*
  # Copy collaborator invite permissions on claim

  Team Access stores selected permissions on the invite. When the invite is
  accepted, copy that permission set into the collaborator membership row.
*/
...
BEGIN
  ...
  VALUES (
    ...
    auth.uid(),
    v_invite.role::collaborator_role,
    v_invite.invited_by,
