/*
  # Remove Manual Demo User and Allow Signup

  ## Overview
  Removes the manually created demo user and restores the trigger-based approach.
  The demo user will be created properly through Supabase auth.signUp() on first use.

  ## Changes
  1. Deletes manually created demo user
  2. Keeps the trigger function to create demo data when user signs up
  3. Allows proper password hashing through Supabase auth API
*/
