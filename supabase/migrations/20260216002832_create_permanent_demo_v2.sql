/*
  # Create Permanent Demo Account v2

  ## Overview
  Creates a permanent demo account with consistent data.
  Uses cleaner SQL to avoid ambiguous column references.
*/
...
BEGIN
  ...
  VALUES 
    ...
    (v_demo_site_id, 'https://images.pexels.com/photos/3014856/pexels-photo-3014856.jpeg', 'Engagement photos', 'engagement', 3);
  ...
  VALUES 
    ...
    (v_demo_site_id, 'faq', 'FAQ', 'Garden formal attire. Dancing all night!', 2);
  ...
  VALUES 
    ...
    (v_demo_site_id, 'RSVP Reminder', 'Please RSVP soon!', 'email', 'pending', 30);
