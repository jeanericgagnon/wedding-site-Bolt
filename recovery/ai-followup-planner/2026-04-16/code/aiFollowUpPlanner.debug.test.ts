...
const cases: EvalCase[] = [
  ...
  },
  {
    ...
    expectedOverall: 'good',
    expectedNonEventKey: 'guest-feel',
    answers: {
      names: 'Ava & Ben',
      labelPreference: 'names-only',
  ...
  {
    name: 'Noah + Tyler remote start',
    expectedOverall: 'good',
    expectedNonEventKey: 'meeting-city',
    notes: 'Should use meeting-city over generic story follow-up when digital origin is clear.',
    answers: {
      names: 'Noah & Tyler',
      labelPreference: 'names-only',
      whenWhere: 'October 11, 2027 — Palm Springs, California',
      venueNameOrTbd: 'Parker Palm Springs',
      style: 'modern desert',
      weekendEventsRaw: 'welcome drinks Friday, wedding Saturday',
      ceremonyArrivalTime: '5:00 PM',
      guestCountBand: '100-150',
      plusOnePolicy: 'some',
      rsvpDeadline: '2027-08-10',
      mealChoice: 'yes',
      registryIntent: 'gifts',
      optionalStory: 'We met on Hinge and talked long-distance for months before finally meeting in person.',
    },
  },
  {
    name: 'Sophie + Daniel registry unclear',
    expectedOverall: 'good',
    expectedNonEventKey: 'registry-posture',
    notes: 'Should surface registry posture when operations are light and gifts language is unresolved.',
    answers: {
      names: 'Sophie & Daniel',
      labelPreference: 'names-only',
      whenWhere: 'May 8, 2027 — Nashville, Tennessee',
      venueNameOrTbd: 'The Cordelle',
      style: 'warm, classic',
      weekendEventsRaw: '',
      ceremonyArrivalTime: '4:30 PM',
      guestCountBand: '50-100',
      ...
      mealChoice: 'yes',
      registryIntent: '',
      optionalStory: 'We met through friends and knew pretty quickly this was it.',
    },
  },
];
