...
_What must change before GO:_ close the anon-auth RSVP blocker, log the canonical couple-path truth pass, and verify starter-draft wording against live runtime behavior
