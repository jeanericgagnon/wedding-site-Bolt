...
| Guestbook | `/guestbook/:siteRef` | Covered | Narrow | Guestbook submission route exists, but its proof depth is lighter than RSVP/photo/vault. | Keep as the guestbook route and avoid overclaiming moderation/readback depth until stronger runtime proof exists. |
