...
2. Sites are intended to be publicly readable when published, while unpublished access should remain non-public in the current product model and public copy
