...
2. Sites are intended to be publicly readable when published, while unpublished access should stay limited to intentional private-preview behavior based on the current implementation and language model
