...
const steps = [
  {
    ...
    command: 'npm test -- --run src/lib/guestHubOfflineSnapshot.test.ts src/lib/dayOfWebModeReadiness.test.ts src/lib/publicAccessArtifacts.test.ts src/lib/serviceWorkerSafety.test.ts src/pages/eventHubPageHelpers.test.ts src/pages/EventHubLiveContent.proof.test.tsx',
    required: true,
  },
  {
    id: 'build',
