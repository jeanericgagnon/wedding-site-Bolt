...
const checks = [
  ...
  { name: 'registry proof output encodes remaining runtime truth gap', ok: registryProof.includes("status: 'manual-proof-pending'") && registryProof.includes("highestRiskTrustGap: 'runtime_registry_truth_after_real_edits'") && registryProof.includes('manualProofRequired: true') },
