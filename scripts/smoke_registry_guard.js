...
const checks = [
  ...
  { name: 'builder registry manifest exposes template-backed and legacy registry variants', ok: sectionManifests.includes("supportedVariants: ['default', 'cards', 'grid', 'fundHighlight', 'featured', 'minimal', 'honeymoon', 'tabs', 'illustrated', 'classic', 'luxury', 'experiences', 'modern', 'playful']") && sectionManifests.includes("{ id: 'default', label: 'Default'") && sectionManifests.includes("{ id: 'grid', label: 'Grid'") && sectionManifests.includes("'classic'") && sectionManifests.includes("'luxury'") && sectionManifests.includes("'experiences'") && sectionManifests.includes("'modern'") && sectionManifests.includes("'playful'") },
  ...
  { name: 'legacy section registry preserves public registry aliases', ok: legacySectionRegistry.includes("component: RegistryGrid") && legacySectionRegistry.includes("default: RegistryGrid") && legacySectionRegistry.includes("classic: RegistryGrid") && legacySectionRegistry.includes("luxury: RegistryFundHighlight") && legacySectionRegistry.includes("cards: RegistryGrid") && legacySectionRegistry.includes("minimal: RegistryGrid") && legacySectionRegistry.includes("featured: RegistryFundHighlight") },
